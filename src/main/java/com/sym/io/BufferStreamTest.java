...
public class BufferStreamTest {
    ...
    public void fileReaderTest2() throws IOException {
        ...
        FileWriter fileWriter = new FileWriter(getRealPath("pic") + "lol.txt", true);
    ...
    public void bufferReaderTest() throws IOException {
        ...
        BufferedReader bufferedReader1 = new BufferedReader(new FileReader(getRealPath("pic") + "lol.txt"));
        BufferedReader bufferedReade2 = new BufferedReader(new FileReader(getRealPath("pic") + "lol.txt"));
        /*
         * 转换为stream对象
         */
